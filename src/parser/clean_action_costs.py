...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 5:
        raise SystemExit("Usage: %s <INPUT_DOMAIN_FILE> <OUTPUT_DOMAIN_FILE> <INPUT_PROBLEM_FILE> <OUTPUT_PROBLEM_FILE>" % sys.argv[0])
        ...
        if (os.path.isfile(sys.argv[1])):
            ...
            output_domain = os.path.abspath(sys.argv[2])

            if (os.path.isfile(sys.argv[3])):
                input_problem = os.path.abspath(sys.argv[3])
                output_problem = os.path.abspath(sys.argv[4])
        ...
        print "Original domain: " + input_domain
        print "Output domain: " + output_domain
        print "Input problem: " + input_problem
        print "Output problem: " + output_problem + "\n"

        clean_domain_action_costs(input_domain, output_domain)
        clean_problem_action_costs(input_problem, output_problem)
